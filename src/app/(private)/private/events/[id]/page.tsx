...
// RespirationRow and BodyBatteryRow types are used by Prisma query results below.
type _RespirationRow = {
    pk_date: Date;
    userProfilePK: number;
...
export default async function EventDetailPage({
    ...
    const [
        ...
        bodyBatteryRows,
        stressSeriesRows,
        respirationSeriesRows,
        bodyBatterySeriesRows,
    ] = await Promise.all([
    ...
    const respirationSeries: SeriesPoint[] = respirationSeriesRows.map(
        (row) => ({
            date: row.pk_date.toISOString().slice(0, 10),
    ...
    const bodyBatterySeries: SeriesPoint[] = bodyBatterySeriesRows.map(
        (row) => ({
            date: row.pk_date.toISOString().slice(0, 10),
            value:
    ...
    const stressImpact = analyzeSingleEventImpact(
        stressSeries,
        event.startDate,
        event.endDate,
        true,
    );
    const respirationImpact = analyzeSingleEventImpact(
        respirationSeries,
        event.startDate,
        event.endDate,
        true,
    );
    const bodyBatteryImpact = analyzeSingleEventImpact(
        bodyBatterySeries,
        event.startDate,
        event.endDate,
        false,
            ...
            <div className="container">
                ...
                <BSCard className="mb-4 shadow-sm border-0">
                    <div className="d-flex flex-wrap align-items-center mb-2">
                        <span
                            className="fw-bold d-inline-block me-2"
                    ...
                    <p className="text-muted small mt-2 mb-3">
                        Multi-horizon impact details are available below for
                        stress, respiration, and body battery.
                    </p>
                ...
                <BSCard className="mb-4 shadow-sm border-0">
                    ...
                    <div className="mb-4 p-3 border rounded bg-white shadow-sm">
                        ...
                        {stressImpact ? (
                            <div className="row g-2 mb-3">
                                <p className="fw-bold text-dark mt-2 mb-1">
                                    Short-term:
                                </p>
                                {stressImpact.shortTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {stressImpact.shortTerm.percentChange.toFixed(
                                                1,
                                            )}
                                            %.
                                        </p>
                                    ...
                                    <p>
                                        Insufficient data for 7 days before or 7
                                ...
                                {stressImpact.mediumTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {stressImpact.mediumTerm.percentChange.toFixed(
                                                1,
                                            )}
                                        ...
                                        <p>
                                            Z-score:{" "}
                                            {stressImpact.mediumTerm.zScore ===
                                            null
                                                ? "n/a"
                                                : stressImpact.mediumTerm.zScore.toFixed(
                                                      2,
                                                  )}
                                        </p>
                                        <p>
                                    ...
                                    <p>
                                        Insufficient baseline or 0-30 day
                                        post-event data.
                                    </p>
                                )}
                                ...
                                {stressImpact.longTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {stressImpact.longTerm.percentChange.toFixed(
                                                1,
                                            )}
                                            %.
                                        </p>
                                    ...
                                    <p>
                                        Insufficient long-term windows for
                                ...
                                {stressImpact.hasConflictingSignals ? (
                                    <p className="alert alert-warning mt-3">
                                        Signals conflict across time horizons.
                                    </p>
                                ) : null}
                            </div>
                        ) : (
                            <p className="text-muted fst-italic">
                                Not enough stress data for multi-horizon
                                analysis.
                            </p>
                        )}
                    </div>
                    ...
                    <div className="mb-4 p-3 border rounded bg-white shadow-sm">
                        ...
                        {respirationImpact ? (
                                ...
                                {respirationImpact.shortTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {respirationImpact.shortTerm.percentChange.toFixed(
                                                1,
                                            )}
                                            %.
                                        </p>
                                ...
                                {respirationImpact.mediumTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {respirationImpact.mediumTerm.percentChange.toFixed(
                                                1,
                                            )}
                                            % compared to baseline.
                                        </p>
                                        <p>
                                            ...
                                            {respirationImpact.mediumTerm
                                                .zScore === null
                                                ? "n/a"
                                                : respirationImpact.mediumTerm.zScore.toFixed(
                                                      2,
                                                  )}
                                        </p>
                                        <p>
                                ...
                                {respirationImpact.longTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {respirationImpact.longTerm.percentChange.toFixed(
                                                1,
                                            )}
                                            %.
                                        </p>
                            ...
                            <p className="text-muted fst-italic">
                                Not enough respiration data for multi-horizon
                                analysis.
                            </p>
                        )}
                    </div>
                    ...
                    <div className="mb-4 p-3 border rounded bg-white shadow-sm">
                        ...
                        {bodyBatteryImpact ? (
                                ...
                                {bodyBatteryImpact.shortTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {bodyBatteryImpact.shortTerm.percentChange.toFixed(
                                                1,
                                            )}
                                            %.
                                        </p>
                                ...
                                {bodyBatteryImpact.mediumTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {bodyBatteryImpact.mediumTerm.percentChange.toFixed(
                                                1,
                                            )}
                                            % compared to baseline.
                                        </p>
                                        <p>
                                            ...
                                            {bodyBatteryImpact.mediumTerm
                                                .zScore === null
                                                ? "n/a"
                                                : bodyBatteryImpact.mediumTerm.zScore.toFixed(
                                                      2,
                                                  )}
                                        </p>
                                        <p>
                                ...
                                {bodyBatteryImpact.longTerm ? (
                                    <>
                                        <p>
                                            ...
                                            by{" "}
                                            {bodyBatteryImpact.longTerm.percentChange.toFixed(
                                                1,
                                            )}
                                            %.
                                        </p>
                            ...
                            <p className="text-muted fst-italic">
                                Not enough body battery data for multi-horizon
                                analysis.
                            </p>
                        )}
                    </div>
                ...
                <BSCard className="mb-4 shadow-sm border-0">
                    <h2 className="h4 mb-4 border-bottom pb-2">
                        Detailed Metrics During This Important Day
                    </h2>

                    <BSCard className="mb-4 p-3 border rounded bg-white shadow-sm">
                        <h3 className="h5 mb-3 text-secondary">
                            Stress (all properties)
                        </h3>
                        {stressRows.length === 0 ? (
                            <p className="text-muted fst-italic">
                                No stress rows found for this date range.
                            </p>
                        ) : (
                            stressRows.map((row) => (
                                <div
                                    key={`stress-${row.pk_date.toISOString()}`}
                                    className="mb-4 border-bottom pb-3"
                                >
                                    <p className="fw-bold mb-2">
                                        {toDateLabel(row.pk_date)}
                                    </p>
                    ...
                    <BSCard className="mb-4 p-3 border rounded bg-white shadow-sm">
                        <h3 className="h5 mb-3 text-secondary">
                            Respiration (all properties)
                        </h3>
                        {respirationRows.length === 0 ? (
                            <p className="text-muted fst-italic">
                                No respiration rows found for this date range.
                            </p>
                        ) : (
                            respirationRows.map((row) => (
                                <div
                                    key={`respiration-${row.pk_date.toISOString()}`}
                                    className="mb-4 border-bottom pb-3"
                                >
                                    <p className="fw-bold mb-2">
                                        {toDateLabel(row.pk_date)}
                    ...
                    <BSCard className="mb-4 p-3 border rounded bg-white shadow-sm">
                        <h3 className="h5 mb-3 text-secondary">
                            Body Battery (all properties)
                        </h3>
                        {bodyBatteryRows.length === 0 ? (
                            <p className="text-muted fst-italic">
                                No body battery rows found for this date range.
                            </p>
                        ) : (
                            bodyBatteryRows.map((row) => (
                                <div
                                    key={`body-battery-${row.pk_date.toISOString()}`}
                                    className="mb-4 border-bottom pb-3"
                                >
                                    <p className="fw-bold mb-2">
                                        {toDateLabel(row.pk_date)}
