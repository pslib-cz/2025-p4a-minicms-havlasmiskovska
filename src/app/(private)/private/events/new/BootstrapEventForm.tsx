...
export default function BootstrapEventForm() {
            ...
            const res = await fetch("/api/events", {
                ...
                body: JSON.stringify({
                    ...
                    tags: String(form.get("tags") || "")
                        ...
                        .map((t) => t.trim())
                        .filter(Boolean),
                    expectedEffect: form.get("expectedEffect") || "NEGATIVE",
                    visibility: form.get("visibility") || "NOT_PUBLIC",
        ...
        <Form onSubmit={handleSubmit} className="needs-validation">
                        ...
                        <div className="col-md-6">
                            <Form.Group>
                                ...
                                <Form.Select
                                    ...
                                    className="form-control-lg bg-light border-0 cursor-pointer"
                                >
            ...
            <div className="card shadow-sm border-0 mb-5 rounded-4 overflow-hidden">
                <div className="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
                    ...
                    <p className="text-muted small mt-1 mb-0">
                        Supported: H1, H2, list, links, images and file
                        attachments.
                    </p>
                </div>
                <div className="card-body p-4">
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 bg-white p-4 shadow-sm border-0 rounded-4 mb-5">
                ...
                <Button
                    ...
                    disabled={saving}
                >
                    {saving ? "Saving..." : "Save Important Day"}
                </Button>
            </div>
        </Form>
    );
